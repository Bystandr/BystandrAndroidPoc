package com.vtnetzwelt.webrtcclient;
...
public class WebRtcClient {
     ...
     */
    public void start(String name, String lat, String lng){
        setCamera();
        try {
            JSONObject message = new JSONObject();
     ...
     * @param name client name
     */
    public void update(String name, String lat, String lng){
        try {
            JSONObject message = new JSONObject();/*
            message.put("id", client.id());*/
            message.put("name", name);
            message.put("lat", lat);
            message.put("lng", lng);
